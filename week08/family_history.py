...
def print_death_age(people_dict):
    ...
    Return: nothing
    """
    print('Person´s name and age at death:')
    for item in people_dict.items():
        ...
        print(f'{name} birth year {value[BIRTH_YEAR_INDEX]} death at {death_age}')
    print('===================================')
...
def print_marriages(marriages_dict, people_dict):
    ...
    for item in marriages_dict.items():
        ...
        husbands_birth_year = husband_data[BIRTH_YEAR_INDEX]
        wifes_birth_year = wife_data[BIRTH_YEAR_INDEX]

        husbands_wedding_year = int(wedding_year) - int(husbands_birth_year)
        wifes_wedding_year = int(wedding_year) - int(wifes_birth_year)
        
        print(f'Husband´s name: {husband_data[NAME_INDEX]}')
        print(f'Husband´s wedding year: {husbands_wedding_year}')
        print(f'Year of the weding: {wedding_year}')
        print(f'Wife´s name: {wife_data[NAME_INDEX]}')
        print(f'Wife´s wedding year: {wifes_wedding_year}')
        print('-------------00-----------------')
