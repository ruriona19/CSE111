...
def main():
    ...
    draw_oval(canvas, 450, 420, 200, 420, width=120, outline="white", fill="")
    draw_oval(canvas, 400, 380, 300, 380, width=120, outline="white", fill="")
    draw_oval(canvas, 500, 440, 300, 440, width=120, outline="white", fill="")
