...
def populate_main_window(frm_main):
    ...
    ent_notes = tk.Text(frm_main, width=65, height=10)
    ...
    btn_add_notes.grid(row=0, column=0, padx=3, pady=3)
    btn_view_notes.grid(row=0, column=1, padx=3, pady=3)
    btn_delete_notes.grid(row=0, column=2, padx=3, pady=3)
    btn_update_notes.grid(row=0, column=3, padx=3, pady=3)
    lbl_notes_title.grid(row=1, column=0, padx=3, pady=3, sticky='W')
    ent_notes_title.grid(row=2, column=0, columnspan=4, padx=3, pady=3)
    lbl_notes.grid(row=3, column=0, columnspan=4, padx=3, pady=3, sticky='W')
    ent_notes.grid(row=4, rowspan=3, column=0, columnspan=4, padx=3, pady=3, sticky='W')
